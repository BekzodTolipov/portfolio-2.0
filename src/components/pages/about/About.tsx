...
const AboutBody = () => {
  return (
    <div className='row'>
      <div className='about-content col-sm-12 col-md-8'>
        <div className='row'>
          <div className='col-sm-12  left-justification'>
            <p className='left-justification'>
              ...
              concepts into real world assets. Angular, Spring Boot, Salesforce,
              and AWS are just the tip of the iceberg when it comes to what I
              can do. I have assisted in building companies from the ground up,
              partnered with strategic stakeholders such as Walmart, UPS, and
              Fedex, in addition to having implemented flexible solutions across
              platforms.
            </p>
            {/* <p>
      ...
      <div className='about-content col-sm-4 col-md-4'>
        <img
          className='headshot'
